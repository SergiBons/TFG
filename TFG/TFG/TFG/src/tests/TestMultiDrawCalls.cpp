...
namespace test {
    ...
    test::TestMultiDrawCalls::TestMultiDrawCalls()
    ...
    void test::TestMultiDrawCalls::OnUpdate(float deltaTime)
    {
    }

    void test::TestMultiDrawCalls::OnRender()
    {
    ...
    void test::TestMultiDrawCalls::OnImGuiRender()
    {
