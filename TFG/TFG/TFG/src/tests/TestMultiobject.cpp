...
#include "TestMultiobject.h"
#include "Renderer.h"

namespace test {

	test::TestMultiobject::TestMultiobject()
	...
	void test::TestMultiobject::OnUpdate(float deltaTime)
	{
	}

	void test::TestMultiobject::OnRender()
	{
	...
	void test::TestMultiobject::OnImGuiRender()
	{
